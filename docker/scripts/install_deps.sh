...
MODULES="masquerade-8.x-2.0-beta4.tar.gz flag-8.x-4.0-beta3.tar.gz twig_tweak-8.x-2.9.tar.gz auto_username-8.x-1.2.tar.gz token-8.x-1.10.tar.gz fullcalendar_view-5.1.2.tar.gz smtp-8.x-1.0.tar.gz gdoc_field-8.x-1.3.tar.gz menu_item_role_access-8.x-2.0.tar.gz"
